          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 mt-12">
            ...
            <AnimatedSection direction="right">
              <div className="tamrapatra-card rounded-2xl p-8 border border-secondary/25">
                <GoldCorner className="w-5 h-5" />
                <h3 className="font-heading text-xl text-white mb-6 tracking-wide">Inscribe Your Message</h3>
                <form className="space-y-5">
                  ...
                  <button
                    type="button"
                    className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-primary to-primary/80 border border-secondary text-secondary font-bold rounded-lg hover:from-secondary hover:to-secondary hover:text-background transition-all duration-300 text-xs uppercase tracking-[0.15em] cursor-pointer shadow-lg shadow-primary/20"
                  >
                    <Send size={14} />
                    Send Scroll
                  </button>
